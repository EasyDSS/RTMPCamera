...
static int pthread_cond_init(pthread_cond_t *cond, const void *unused_attr)
{
    ...
    win32_cond = (win32_cond_t*)calloc(1, sizeof(win32_cond_t));
    if (!win32_cond)
        return ENOMEM;
    cond->Ptr = win32_cond;
...
static void w32thread_init(void)
{
    ...
    cond_init      = (void (__stdcall*)(pthread_cond_t*))
		GetProcAddress(kernel_dll, "InitializeConditionVariable");
    cond_broadcast = (void (__stdcall*)(pthread_cond_t*))
		GetProcAddress(kernel_dll, "WakeAllConditionVariable");
    cond_signal    = (void (__stdcall*)(pthread_cond_t*))
		GetProcAddress(kernel_dll, "WakeConditionVariable");
    cond_wait      = (BOOL (__stdcall*)(pthread_cond_t*, pthread_mutex_t*, DWORD))
		GetProcAddress(kernel_dll, "SleepConditionVariableCS");
    initonce_begin = (BOOL (__stdcall*)(pthread_once_t*, DWORD, BOOL*, void**))
		GetProcAddress(kernel_dll, "InitOnceBeginInitialize");
    initonce_complete = (BOOL (__stdcall*)(pthread_once_t*, DWORD, void*))
